...
public class TankNormal extends Tank {
	...
	public TankNormal(double x, double y, double health, double armor,
			double moveSpeed, int money) {
		super(DEFAULT_IMAGE, x, y, health, armor, moveSpeed, money);
		level = health/DEFAULT_HEALTH-1;
	}
	
	public TankNormal(double x, double y, double modifier) {
	...
	public void onDeath() {
		super.onDeath();
		Particle part = new Corpse(Images.normalTankDead, x, y, 0, 0);
