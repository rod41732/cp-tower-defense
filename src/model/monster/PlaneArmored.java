...
public class PlaneArmored extends Plane {
	...
	public PlaneArmored(double x, double y, double health, double armor,
			double moveSpeed, int money) {
		super(DEFAULT_IMAGE, x, y, health, armor, moveSpeed, money);
		level = health/DEFAULT_HEALTH-1;
	}
	
	public PlaneArmored(double x, double y, double modifier) {
